...
class ECM():
    def __init__(self, r, p1, p2, p3, q1, q2, q3, battery_num):
        ...
        # Load battery data
        self.bat = []
        self.bat.append(pd.read_csv(f'data/padded_data_mod_volt[{self.battery_num}].csv'))
...
# ecm = ECM(192.47058823529412, 5.107529411764705, 38.4375294117647, 48.24047058823529, 38.4375294117647, 48.24047058823529, 0.4021176470588235, battery_num='B0005') #[MSE: 0.1392]
# ecm = ECM(192.47058823529412, 8.636588235294116, 30.98729411764706, 89.02070588235294, 30.98729411764706, 89.02070588235294, 0.4021176470588235, battery_num='B0006') #[MSE: 0.17698]
# ecm = ECM(44.94117647058823, 87.45223529411764, 1.9705882352941175, 84.31529411764706, 1.9705882352941175, 84.31529411764706, 91.7655294117647, battery_num='B0007') #[MSE: 0.3725]
# ecm = ECM(103.17647058823529, 12.949882352941176, 77.64929411764706, 68.63058823529413, 77.64929411764706, 68.63058823529413, 36.47694117647058, battery_num='B0018') #[MSE: 0.1004]
