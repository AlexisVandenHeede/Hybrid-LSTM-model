...
"""
# Training model
model, train_loss_history, val_loss_history = train_batch(model, train_dataloader=train_dataset, val_dataloader=validation_dataset, n_epoch=n_epoch, lf=lf, optimiser=opimiser, verbose=True)
